...
public class Test
{
	...
	public static void ChangeDirection(ref int x, ref int dx, ref int y, ref int dy)
	{
	...
	public static void Main()
	{
		...
		int barY = Console.WindowHeight - 1;
		...
		while (true)
        {
            ...
            ChangeDirection(ref x, ref dx, ref y, ref dy);
        }
